...
public class VideoApiTest {
     ...
     */
    @Test
    public void costTest() throws ApiException {
        String audioUrl = null;
        String videoUrl = null;
        api.cost(audioUrl, videoUrl)
                .execute();
     ...
     */
    @Test
    public void getLipSyncJobTest() throws ApiException {
        String id = null;
        VideoExtended response = api.getLipSyncJob(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void lipSyncTest() throws ApiException {
        ...
        String model = null;
        VideoInitial response = api.lipSync(audioUrl, videoUrl, synergize)
