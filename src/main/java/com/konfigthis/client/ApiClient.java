...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.synclabs.so";
    ...
    public String getApiKey() {
        return ((ApiKeyAuth) this.getAuthentication("apiKey")).getApiKey();
    }

    public void setApiKey(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("apiKey")).setApiKey(apiKey);
    }

    public void setApiKeyPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("apiKey")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.synclabs.so)
