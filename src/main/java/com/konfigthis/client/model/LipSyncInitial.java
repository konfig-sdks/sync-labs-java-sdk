...
public class LipSyncInitial {
  ...
  public LipSyncInitial() {
  }

  public LipSyncInitial id(String id) {
  ...
  **/
  ...
  public LipSyncInitial url(String url) {
  ...
  **/
  ...
  public LipSyncInitial originalVideoUrl(String originalVideoUrl) {
  ...
  **/
  ...
  public LipSyncInitial originalAudioUrl(String originalAudioUrl) {
  ...
  **/
  ...
  public LipSyncInitial status(String status) {
  ...
  **/
  ...
  public LipSyncInitial synergize(Boolean synergize) {
  ...
  **/
   ...
   * @return the LipSyncInitial instance itself
   */
  public LipSyncInitial putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LipSyncInitial lipSyncInitial = (LipSyncInitial) o;
    return Objects.equals(this.id, lipSyncInitial.id) &&
        Objects.equals(this.url, lipSyncInitial.url) &&
        Objects.equals(this.originalVideoUrl, lipSyncInitial.originalVideoUrl) &&
        Objects.equals(this.originalAudioUrl, lipSyncInitial.originalAudioUrl) &&
        Objects.equals(this.status, lipSyncInitial.status) &&
        Objects.equals(this.synergize, lipSyncInitial.synergize)&&
        Objects.equals(this.additionalProperties, lipSyncInitial.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LipSyncInitial {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LipSyncInitial
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LipSyncInitial.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LipSyncInitial is not found in the empty JSON string", LipSyncInitial.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LipSyncInitial.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LipSyncInitial.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LipSyncInitial' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LipSyncInitial> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LipSyncInitial.class));

       return (TypeAdapter<T>) new TypeAdapter<LipSyncInitial>() {
           @Override
           public void write(JsonWriter out, LipSyncInitial value) throws IOException {
           ...
           @Override
           public LipSyncInitial read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LipSyncInitial instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LipSyncInitial given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LipSyncInitial
  * @throws IOException if the JSON string is invalid with respect to LipSyncInitial
  */
  public static LipSyncInitial fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LipSyncInitial.class);
  }

 /**
  * Convert an instance of LipSyncInitial to an JSON string
  *
  * @return JSON string
  */
