...
public class SpeakDto {
  ...
  public SpeakDto transcript(String transcript) {
  ...
  **/
  ...
  public SpeakDto voiceId(String voiceId) {
  ...
  **/
  ...
  public SpeakDto maxCredits(Double maxCredits) {
  ...
  public SpeakDto maxCredits(Integer maxCredits) {
  ...
  **/
  ...
  public SpeakDto webhookUrl(String webhookUrl) {
  ...
  **/
   ...
   * @return the SpeakDto instance itself
   */
  public SpeakDto putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SpeakDto speakDto = (SpeakDto) o;
    return Objects.equals(this.transcript, speakDto.transcript) &&
        Objects.equals(this.voiceId, speakDto.voiceId) &&
        Objects.equals(this.maxCredits, speakDto.maxCredits) &&
        Objects.equals(this.webhookUrl, speakDto.webhookUrl)&&
        Objects.equals(this.additionalProperties, speakDto.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transcript, voiceId, maxCredits, webhookUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SpeakDto {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SpeakDto
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SpeakDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SpeakDto is not found in the empty JSON string", SpeakDto.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SpeakDto.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SpeakDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SpeakDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SpeakDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SpeakDto.class));

       return (TypeAdapter<T>) new TypeAdapter<SpeakDto>() {
           @Override
           public void write(JsonWriter out, SpeakDto value) throws IOException {
           ...
           @Override
           public SpeakDto read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SpeakDto instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SpeakDto given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SpeakDto
  * @throws IOException if the JSON string is invalid with respect to SpeakDto
  */
  public static SpeakDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SpeakDto.class);
  }

 /**
  * Convert an instance of SpeakDto to an JSON string
  *
  * @return JSON string
  */
